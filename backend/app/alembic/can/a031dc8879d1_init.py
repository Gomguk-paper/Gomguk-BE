...
Revision ID: a031dc8879d1
Revises: 
Create Date: 2026-01-17 16:38:52.458508
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('tag_likes', postgresql.ARRAY(postgresql.ENUM('cs_ai', 'cs_lg', 'cs_cv', 'cs_cl', name='tag_type')), server_default=sa.text("'{}'"), nullable=False),
    ...
    sa.Column('type', postgresql.ENUM('view', 'like', 'unlike', 'save', 'unsave', 'search', name='event_type'), nullable=False),
    ...
    sa.Column('mother', postgresql.ENUM('arxiv', 'github', name='site'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['paper_id'], ['papers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('provider', postgresql.ENUM('google', 'github', name='auth_provider'), nullable=False),
